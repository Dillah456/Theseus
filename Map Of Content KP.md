...
2.1.1. { Tahfidz / Tilawah / Murojaah / Hafalan dalam Al-Quran }

2.1.n. Perencanaan Pembelajaran
...
1. Untuk memperbaiki kualitas pembelajaran perlu diawali dengan perencanaan pembelajaran yang diwujudkan dengan perencanaan pembelajaran yang diwujudkan dengan adanya desain pembelajaran.
...
4. Untuk merencanakan suatu desain pembelajaran diacukan pada siswa secara per-orangan
...
6. Sasaran akhir dan perencanaan desain pembelajaran adalah mudahnya siswa untuk belajar.
7. Perencanaan pembelajaran harus melibatkan semua variabel pembelajaran.
8. Inti dari desain pembelajaran yang dibuat adalah penetapan metode pembelajaran yang optimal untuk mencapai tujuan yang ditetapkan.

2.1.n+1. Evaluasi Pembelajaran
...
Dalam Perencanaan pembelajaran penting untuk mengetahui apakah peserta didik menguasai, mengingat, atau memahami dari hasil suatu pembelajaran.
![[Pasted image 20260203141507.png]]

Untuk mengetahui suatu proses berjalan sesuai perencanaan atau tidak, suatu proses memerlukan proses Evaluasi ""Adalah Penilaian yang sistematik tentang manfaat atau kegunaan suatu objek ( Menhress & Lehmann, 1991 ). Dalam melakukan evaluasi terdapat judgment untuk menentukan nilai suatu program yang sedikit banyak mengandung unsur Subjektif.""(  ).
...
### 2.2. Excel 
---
Excel, adalah Aplikasi yang di distribusikan oleh microsoft dan berada dalam paket Microsoft Office.
Secara Historis Excel versi awalnya di 30 September 1985 bersama dengan saingan nya yang sudah terlebih dahulu mendominasi pasar yaitu Lotus 1-2-3.

Excel sangat mendukung pemprosesan data dan secara luas digunakan hampir disetiap lini, dari Administrasi, Rekap Keuangan, dan di pendidikan sebagai penilaian.
...
---
Learning Management System, adalah sistem pada E-Pembelajaran atau Pembelajaran Elektronik, E-Learning dalam Pendidikan sendiri memiliki 3 fungsi, diantaranya :
1. Suplemen
2. Komplemen
3. Substitusi
...
{ Catatan 2.3. kemungkinan lebih cocok sebagai isi dari Batasan Masalah }
### 2.4. Web Aplication
---
